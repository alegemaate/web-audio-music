...
const GuidedMusic: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    const tick = (now: number) => {
      setStep(Math.floor(((now - start) / speed) % 8));
  ...
  return (
    <Layout>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        An experimental generative composition driven by Conway&apos;s Game of
        Life: cells on the grid trigger notes as they live, die, and replicate,
        producing an ever-evolving piece. Work in progress.
      </Typography>
