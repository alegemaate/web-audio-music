...
const FmAccelerometer: React.FC = () => {
  ...
  const handleFreq1Change = (_event: Event, value: number | number[]) => {
  ...
  const handleFreq2Change = (_event: Event, value: number | number[]) => {
  ...
  const handleGain1Change = (_event: Event, value: number | number[]) => {
  ...
  const handleGain2Change = (_event: Event, value: number | number[]) => {
  ...
  return (
    <Layout>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Tilt your device to modulate the carrier and modulator frequencies of
        a two-operator FM synth. Best on a phone or tablet with motion sensors
        enabled.
      </Typography>
      <Card>
        <CardContent>
